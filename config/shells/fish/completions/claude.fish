...
# Config subcommands
complete -c claude -f -n '__fish_seen_subcommand_from config' -a 'set get list' -d 'Config operations'

# Install subcommand options
complete -c claude -f -n '__fish_seen_subcommand_from install' -a 'stable latest' -d 'Install target'
